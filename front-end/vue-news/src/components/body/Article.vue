    ...
    <div>
        <mdb-container>
            ...
            <!--<mdb-row>-->
                ...
                <!--<mdb-col lg="5">-->
                    <!--<mdb-view class="rounded z-depth-2 mb-lg-0 mb-4" hover>-->
                        <!--<img class="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/img%20(34).jpg"-->
                             <!--alt="Sample image"/>-->
                        <!--<a>-->
                            <!--<mdb-mask overlay="white-slight" waves/>-->
                        <!--</a>-->
            ...
            <!--<mdb-row>-->
                <!--<mdb-col lg="5">-->
                    <!--<mdb-view class="rounded z-depth-2 mb-lg-0 mb-4" hover>-->
                        <!--<img class="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/img (28).jpg"-->
                             <!--alt="Sample image"/>-->
                        <!--<a>-->
                            <!--<mdb-mask overlay="white-slight" waves/>-->
                        <!--</a>-->
...
<script>
    ...
    import {mdbBtn, mdbCol, mdbContainer, mdbIcon, mdbMask, mdbRow, mdbView} from 'mdbvue';
